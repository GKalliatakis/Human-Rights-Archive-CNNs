# -*- coding: utf-8 -*-
"""Human Rights Archive (HRA) VGG19 model for Keras
...
FEATURE_EXTRACTION_AVG_POOL_WEIGHTS_PATH = 'https://github.com/GKalliatakis/crispy-enigma/releases/download/0.1/feature_extraction_VGG19_avg_pool_weights_tf_dim_ordering_tf_kernels.h5'
FEATURE_EXTRACTION_AVG_POOL_fname = 'feature_extraction_VGG19_avg_pool_weights_tf_dim_ordering_tf_kernels'
FEATURE_EXTRACTION_FLATTEN_POOL_WEIGHTS_PATH = 'https://github.com/GKalliatakis/crispy-enigma/releases/download/0.1/feature_extraction_VGG19_flatten_pool_weights_tf_dim_ordering_tf_kernels.h5'
FEATURE_EXTRACTION_FLATTEN_POOL_fname = 'feature_extraction_VGG19_flatten_pool_weights_tf_dim_ordering_tf_kernels'
FEATURE_EXTRACTION_MAX_POOL_WEIGHTS_PATH = 'https://github.com/GKalliatakis/crispy-enigma/releases/download/0.1/feature_extraction_VGG19_max_pool_weights_tf_dim_ordering_tf_kernels.h5'
FEATURE_EXTRACTION_MAX_POOL_fname = 'feature_extraction_VGG19_max_pool_weights_tf_dim_ordering_tf_kernels'

AUGM_FEATURE_EXTRACTION_AVG_POOL_WEIGHTS_PATH = 'https://github.com/GKalliatakis/crispy-enigma/releases/download/0.1/augm_feature_extraction_VGG19_avg_pool_weights_tf_dim_ordering_tf_kernels.h5'
AUGM_FEATURE_EXTRACTION_AVG_POOL_fname = 'augm_feature_extraction_VGG19_avg_pool_weights_tf_dim_ordering_tf_kernels'
AUGM_FEATURE_EXTRACTION_FLATTEN_POOL_WEIGHTS_PATH = 'https://github.com/GKalliatakis/crispy-enigma/releases/download/0.1/augm_feature_extraction_VGG19_flatten_pool_weights_tf_dim_ordering_tf_kernels.h5'
AUGM_FEATURE_EXTRACTION_FLATTEN_POOL_fname = 'augm_feature_extraction_VGG19_flatten_pool_weights_tf_dim_ordering_tf_kernels'
AUGM_FEATURE_EXTRACTION_MAX_POOL_WEIGHTS_PATH = 'https://github.com/GKalliatakis/crispy-enigma/releases/download/0.1/augm_feature_extraction_VGG19_max_pool_weights_tf_dim_ordering_tf_kernels.h5'
AUGM_FEATURE_EXTRACTION_MAX_POOL_fname = 'augm_feature_extraction_VGG19_max_pool_weights_tf_dim_ordering_tf_kernels'

# ======================  ------------------------  ======================  ------------------------  ======================  ------------------------  ======================  ------------------------  ======================  ------------------------
# Weights obtained by un-freezing the two lower convolutional layers and retraining them
FINE_TUNING_AVG_POOL_WEIGHTS_PATH = 'https://github.com/GKalliatakis/crispy-enigma/releases/download/0.2/fine_tuning_VGG19_avg_pool_weights_tf_dim_ordering_tf_kernels.h5'
FINE_TUNING_AVG_POOL_fname = 'fine_tuning_VGG19_avg_pool_weights_tf_dim_ordering_tf_kernels'
FINE_TUNING_FLATTEN_POOL_WEIGHTS_PATH = 'https://github.com/GKalliatakis/crispy-enigma/releases/download/0.2/fine_tuning_VGG19_flatten_pool_weights_tf_dim_ordering_tf_kernels.h5'
FINE_TUNING_FLATTEN_POOL_fname = 'fine_tuning_VGG19_flatten_pool_weights_tf_dim_ordering_tf_kernels'
FINE_TUNING_MAX_POOL_WEIGHTS_PATH = 'https://github.com/GKalliatakis/crispy-enigma/releases/download/0.2/fine_tuning_VGG19_max_pool_weights_tf_dim_ordering_tf_kernels.h5'
FINE_TUNING_MAX_POOL_fname = 'fine_tuning_VGG19_max_pool_weights_tf_dim_ordering_tf_kernels'

AUGM_FINE_TUNING_AVG_POOL_WEIGHTS_PATH = 'https://github.com/GKalliatakis/crispy-enigma/releases/download/0.2/augm_fine_tuning_VGG19_avg_pool_weights_tf_dim_ordering_tf_kernels.h5'
AUGM_FINE_TUNING_AVG_POOL_fname = 'augm_fine_tuning_VGG19_avg_pool_weights_tf_dim_ordering_tf_kernels'
AUGM_FINE_TUNING_FLATTEN_POOL_WEIGHTS_PATH = 'https://github.com/GKalliatakis/crispy-enigma/releases/download/0.2/augm_fine_tuning_VGG19_flatten_pool_weights_tf_dim_ordering_tf_kernels.h5'
AUGM_FINE_TUNING_FLATTEN_POOL_fname = 'augm_fine_tuning_VGG19_flatten_pool_weights_tf_dim_ordering_tf_kernels'
AUGM_FINE_TUNING_MAX_POOL_WEIGHTS_PATH = 'https://github.com/GKalliatakis/crispy-enigma/releases/download/0.2/augm_fine_tuning_VGG19_max_pool_weights_tf_dim_ordering_tf_kernels.h5'
AUGM_FINE_TUNING_MAX_POOL_fname = 'augm_fine_tuning_VGG19_max_pool_weights_tf_dim_ordering_tf_kernels'

# ======================  ------------------------  ======================  ------------------------  ======================  ------------------------  ======================  ------------------------  ======================  ------------------------
# Weights obtained from removing the classification block from the fine-tuned models
FINE_TUNING_WEIGHTS_PATH_NO_TOP = 'https://github.com/GKalliatakis/crispy-enigma/releases/download/0.2/fine_tuning_VGG19_weights_tf_dim_ordering_tf_kernels_notop.h5'
FINE_TUNING_WEIGHTS_PATH_NO_TOP_fname ='fine_tuning_VGG19_weights_tf_dim_ordering_tf_kernels_notop'
# ======================  ------------------------  ======================  ------------------------  ======================  ------------------------  ======================  ------------------------  ======================  ------------------------
...
if __name__ == '__main__':
    ...
    # model = HRA_VGG19(weights='HRA', mode='feature_extraction', pooling_mode='avg', include_top=True)

    model = HRA_VGG19(weights='HRA', mode='fine_tuning', pooling_mode='avg', include_top=True)
