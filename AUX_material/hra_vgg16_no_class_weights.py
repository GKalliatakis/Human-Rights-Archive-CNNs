...
FEATURE_EXTRACTION_AVG_POOL_WEIGHTS_PATH = 'https://github.com/GKalliatakis/crispy-enigma/releases/download/v0.1/feature_extraction_VGG16_avg_pool_weights_tf_dim_ordering_tf_kernels.h5'
...
FINE_TUNING_AVG_POOL_WEIGHTS_PATH = 'https://github.com/GKalliatakis/crispy-enigma/releases/download/v0.1/fine_tuning_VGG16_avg_pool_weights_tf_dim_ordering_tf_kernels.h5'
FINE_TUNING_AVG_POOL_fname = 'fine_tuning_VGG16_avg_pool_weights_tf_dim_ordering_tf_kernels'
FINE_TUNING_FLATTEN_POOL_WEIGHTS_PATH = 'https://github.com/GKalliatakis/crispy-enigma/releases/download/v0.1/fine_tuning_VGG16_flatten_pool_weights_tf_dim_ordering_tf_kernels.h5'
FINE_TUNING_FLATTEN_POOL_fname = 'fine_tuning_VGG16_flatten_pool_weights_tf_dim_ordering_tf_kernels'
FINE_TUNING_MAX_POOL_WEIGHTS_PATH = 'https://github.com/GKalliatakis/crispy-enigma/releases/download/v0.1/fine_tuning_VGG16_max_pool_weights_tf_dim_ordering_tf_kernels.h5'
